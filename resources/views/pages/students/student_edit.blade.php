        ...
        <div class="mb-3">
            ...
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <button type="button" onclick="editData(this)" class="btn btn-primary btn-rounded">Submit
                    </button>
                </div>
...
<script>
    ...
    function editData(e) {
        ...
        var updateURL = `${apiBase}students/${id}`
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res['code'] == 200) {
                    ...
                    window.location=`{{ route('all_students',['lang'=>app()->getLocale()]) }}`
                }
