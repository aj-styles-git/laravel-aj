                ...
                <form id="AddFormSubmit" class="needs-validation" novalidate>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="code" id="basicpill-firstname-input"
                                    placeholder="Ex :- GET100 " value="{{ $coupon->code }}">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" data-trigger name="type">
                                    ...
                                    <option value="1" @if ($coupon->type == 1) selected @endif>{{ __('Flat Discount') }}</option>
                                    <option value="0" @if ($coupon->type == 0) selected @endif>{{ __('In Percentage') }}</option>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="amount" id="basicpill-firstname-input"
                                    placeholder="Percentage or Amount  " value="{{ $coupon->amount }}">
                                <div class="text-danger" id="name">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" data-trigger name="institute_id"
                                    ...
                                    <option value="0" @if ($coupon->institute_id == 0) selected @endif>{{ __('All Institutes') }}</option>

                                    @foreach ($institutes as $institute)
                                        <option value="{{ $institute->id }}"
                                            @if ($institute->id == $coupon->institute_id) selected @endif>{{ $institute->name }}
                                        </option>
                                    @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            <button type="button" onclick="updateData(this)" class="btn btn-primary btn-rounded">{{ __('Submit') }}
                            </button>
                        </div>
